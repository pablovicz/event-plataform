...
export type GetLessonsSlugsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetLessonsSlugsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', slug?: string | null }> };
...
export const GetLessonsSlugsDocument = gql`
    query getLessonsSlugs {
  lessons(orderBy: availableAt_ASC, stage: PUBLISHED) {
    slug
  }
}
...
/**
 * __useGetLessonsSlugsQuery__
 *
 * To run a query within a React component, call `useGetLessonsSlugsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetLessonsSlugsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetLessonsSlugsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetLessonsSlugsQuery(baseOptions?: Apollo.QueryHookOptions<GetLessonsSlugsQuery, GetLessonsSlugsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLessonsSlugsQuery, GetLessonsSlugsQueryVariables>(GetLessonsSlugsDocument, options);
      }
export function useGetLessonsSlugsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLessonsSlugsQuery, GetLessonsSlugsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLessonsSlugsQuery, GetLessonsSlugsQueryVariables>(GetLessonsSlugsDocument, options);
        }
export type GetLessonsSlugsQueryHookResult = ReturnType<typeof useGetLessonsSlugsQuery>;
export type GetLessonsSlugsLazyQueryHookResult = ReturnType<typeof useGetLessonsSlugsLazyQuery>;
export type GetLessonsSlugsQueryResult = Apollo.QueryResult<GetLessonsSlugsQuery, GetLessonsSlugsQueryVariables>;